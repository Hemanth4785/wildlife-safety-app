...
interface RegisterScreenProps {
    onRegister: (name: string, email: string, pass: string) => Promise<string | null>;
    onSwitchToLogin: () => void;
}

const RegisterScreen: React.FC<RegisterScreenProps> = ({ onRegister, onSwitchToLogin }: RegisterScreenProps) => {
